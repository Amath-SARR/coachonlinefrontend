...
- [**The Hitchhiker's Guide to `react-boilerplate`**](general/introduction.md): An introduction for newcomers to this boilerplate.
- [Overview](general): A short overview of the included tools
- [**Commands**](general/commands.md): Getting the most out of this boilerplate
- [Testing](testing): How to work with the built-in test harness
- [Styling](css): How to work with the CSS tooling
- [Your app](js): Supercharging your app with Routing, Redux, simple
  asynchronicity helpers, etc.
- [**Troubleshooting**](general/gotchas.md): Solutions to common problems faced by developers.
